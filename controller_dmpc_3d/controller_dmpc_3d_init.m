function [a, fit_val, exit_flag] = controller_dmpc_3d_init(s, delta_vel, params, opt, edge_agents)
...
for i = 1:numel(edge_agents)
    ...
    [u, fit_val, exit_flag] = fmincon(@(u)cost_sum_init(u, s_local, params),zeros(3*params.h,1),[],[],[],[],lb,ub,@(u)constraints(u, params),opt);
    a_h = u2acc(u, params);
    a(:,i) = a_h(:,1);
