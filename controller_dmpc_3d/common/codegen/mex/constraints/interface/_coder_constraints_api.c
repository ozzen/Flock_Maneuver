  ...
  emlrtMsgIdentifier *parentId, struct0_T *y)
{
  ...
  y->t_fix = e_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 11,
    "t_fix")), &thisId);
  thisId.fIdentifier = "t_cont";
  y->t_cont = e_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 12,
    "t_cont")), &thisId);
  ...
  y->eta = e_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 14,
    "eta")), &thisId);
  thisId.fIdentifier = "jerk";
  y->jerk = e_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 15,
    "jerk")), &thisId);
  ...
  y->steps = e_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 17,
    "steps")), &thisId);
  thisId.fIdentifier = "m";
  y->m = e_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 18, "m")),
    &thisId);
  thisId.fIdentifier = "L";
  y->L = e_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 19, "L")),
    &thisId);
  thisId.fIdentifier = "dmin";
  y->dmin = e_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 20,
    "dmin")), &thisId);
  thisId.fIdentifier = "g";
  y->g = e_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 21, "g")),
    &thisId);
  thisId.fIdentifier = "j_r";
  y->j_r = e_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 22,
    "j_r")), &thisId);
  thisId.fIdentifier = "Ixx";
  y->Ixx = e_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 23,
    "Ixx")), &thisId);
  thisId.fIdentifier = "Iyy";
  y->Iyy = e_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 24,
    "Iyy")), &thisId);
  thisId.fIdentifier = "Izz";
  y->Izz = e_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 25,
    "Izz")), &thisId);
  ...
  y->k_f = e_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 29,
    "k_f")), &thisId);
  thisId.fIdentifier = "k_m";
  y->k_m = e_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 30,
    "k_m")), &thisId);
  thisId.fIdentifier = "wc";
  y->wc = e_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 31,
    "wc")), &thisId);
  thisId.fIdentifier = "ws";
  y->ws = e_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 32,
    "ws")), &thisId);
  thisId.fIdentifier = "quad";
  y->quad = e_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 33,
    "quad")), &thisId);
  ...
  y->knn = e_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 35,
    "knn")), &thisId);
  thisId.fIdentifier = "turn";
  y->turn = e_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 36,
    "turn")), &thisId);
  thisId.fIdentifier = "w_m";
  g_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 37, "w_m")),
                     &thisId, y->w_m);
